     ...
     <div class="row">
        <div class="col-md-12">
           <div class="tile">
              ...
              <div class="row">
                <div class="col-md-12">
                  <form id="addpackageform" enctype="multipart/form-data" method="post" action="{{route('admin.store.hotel')}}"  >
                    @csrf
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" name="htl_name" value="" placeholder="Enter Package Name" >
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <div class="input-group mb-3">
                            <input type="text" class="form-control" name="phone" value="" placeholder="Enter your phone number">
                          </div>
                          <p class="no-margin em"></p>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <div class="input-group mb-3">
                            <input type="text" name="address" class="form-control" placeholder="Enter your address" aria-label="Recipient's username" aria-describedby="basic-addon2">
                          </div>
                          <p class="no-margin em"></p>
                        </div>
                      </div>
