...
<div class="tile">
             ...
             <div class="pull-right icon-btn">
               <a class="btn btn-info" href="{{route('admin.all.hotel')}}">
                ...
                <table class="table">
                   ...
                   <tbody>
                     ...
                     <tr>
                         ...
                         <td>{{$room->room_name}}</a></td>
                         <td>{{$room->no_person}}</td>
                         <td>{{$room->price}}</td>
                         <td>
                           <a href="{{route('admin.edit.room', $room->id)}}" class="btn btn-warning"><i class="fa fa-pencil-square"></i> Edit</a>
                          <button id="hideShowBtn9" class="btn btn-danger" onclick="showHideRoom(event, 9)">Hide</button>
                         </td>
                       </tr>
                       @endforeach
                   </tbody>
