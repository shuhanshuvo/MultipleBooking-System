...
<main class="app-content">
      <div class="row user">
        <div class="col-md-12">
          <div class="profile">
            <div class="info"><img class="user-img" src="{{ asset('backend/photo/'.$admin['photo']) }}" alt="{{ $admin->photo }}">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="user-timeline">
              ...
              <div class="timeline-post">
                <div class="post-media"><a href="#"><img style="height: 50px; width: 50px;" src="{{ asset('backend/photo/'.$admin['photo']) }}" alt="{{ $admin->photo }}"></a>
                  <div class="content">
                ...
                <form method="POST" action="{{route('admin.update.profile')}}" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-md-8 mb-4">
                      <label>Photo</label>
                      <img  style="height: 50px; width: 50px;"src="{{ asset('backend/photo/'.$admin['photo']) }}" alt="{{ $admin->photo }}">
                      <input class="form-control" name="photo" value="{{$admin->photo}}" type="file">
                    </div>
                    <div class="col-md-8 mb-4">
                      <label>Name</label>
