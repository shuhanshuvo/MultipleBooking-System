     ...
     <div class="row">
        <div class="col-md-12">
           <div class="tile">
              ...
              <div class="row">
                <div class="col-md-12">
                  <form id="addpickupform" enctype="multipart/form-data" action="{{route('admin.store.rentCar')}}" method="post">
                  	@csrf
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" name="location" value="" placeholder="Enter Pickup Car Title">
                          <p class="no-margin em"></p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="price" value="" placeholder="Enter payment">
                      <p class="no-margin em"></p>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <button type="submit" class="btn btn-info btn-block form-control-lg">ADD RENT CAR</button>
                      </div>
                    </div>
                  </form>
                </div>
