     ...
     <div class="row">
        <div class="col-md-12">
           <div class="tile">
              ...
              <div class="row">
                <div class="col-md-12">
                  <form id="addpickupform" enctype="multipart/form-data" action="{{route('admin.update.pickup')}}" method="post">
                  	@csrf
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="">
                          <table class="table table-striped" id="imgtable">
                          	...
                          	<img style="height: 100px; width:auto;" src="{{ asset('/backend/Pickup/img/'.$pickup['img']) }}">
                    ...
                    <div class="row">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" name="location" value="{{$pickup->location}}" placeholder="Enter Location Name">
                          <p class="no-margin em"></p>
                        </div>
                      </div>
                    </div>
                     ...
                     <div class="form-group">
                         ...
                         <textarea id="summernote" cols="6" rows="6" value="" class="form-control" name="overview">{!!$pickup->overview!!}</textarea>
                    </div>
