...
<div class="app-title">
        <div>
         ...
         <!--  <h5 class="section__heading card-header info-color white-text text-center py-4" style="
          ...
          <hr class="mb-4">
          <form action="{{route('store.package.checkout')}}" method="post">
            @csrf
            ...
            <div id="bkash" class="collapse card text-light bg-dark formdiv">
               <div class="card-footer text-muted">
                  <p align="justify">Fillup below form."SEND MONEY" cost will be added with net price.Total amount you need to send us at <b>Tk {{$package->price}}</b></p>
               </div>
            ...
            <div id="bank" class="collapse card text-light bg-dark bankDiv">
               <div class="card-footer text-muted">
                  <p align="justify">Fillup below form.Also note that 5% Bank "SEND MONEY" cost will be added with net price.Total amount you need to send us at <b>Tk {{$package->price}} </b></p>
               </div>
               <div class="card-body bg-light text-info">
