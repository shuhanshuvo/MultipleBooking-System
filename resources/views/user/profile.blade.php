...
<main class="app-content">
      <div class="row user">
        <div class="col-md-12">
          <div class="profile">
            <div class="info"><img class="user-img" src="{{ asset('backend/photo/'.$user['photo']) }}" alt="{{ $user->photo }}">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="user-timeline">
              ...
              <div class="timeline-post">
                <div class="post-media"><a href="#"><img style="height: 50px; width: 50px;" src="{{ asset('backend/photo/'.$user['photo']) }}" alt="{{ $user->photo }}"></a>
                  <div class="content">
